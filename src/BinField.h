...
class BinField {
 ...
 public:
  ...
  void xout(const unsigned &precision=15) const;
  void xout(const unsigned &xlow, const unsigned &xup, const unsigned &ylow, const unsigned &yup, const unsigned &precision=15) const;
...
template < typename valuetype >
void BinField<valuetype>::xout(const unsigned &precision) const
{
  xout(0,Nx_-1,0,Ny_-1,precision);
}

template < typename valuetype >
void BinField<valuetype>::xout(const unsigned &xlow, const unsigned &xup, const unsigned &ylow, const unsigned &yup, const unsigned &precision) const
{
  ...
  for(unsigned yi = yup+1; yi > ylow; yi--)
    {
      for(unsigned xi = xlow; xi <= xup; xi++)
        std::cout << std::setw(precision) << call(xi,yi-1);
      std::cout << std::endl;
    }
  std::cout << std::endl;
}
